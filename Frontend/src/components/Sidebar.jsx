...
const Sidebar = () => {
    ...
    const sidebarContent = (expanded) => (
        <>
            ...
            <div className={`overflow-hidden transition-all duration-500 ease-out ${expanded ? "max-h-60 opacity-100" : "max-h-0 opacity-0"}`}>
                <div className="p-3">
                    <div className="relative">
                        ...
                        <div className="h-24 rounded-xl bg-gradient-to-br from-sky-200 via-sky-100 to-blue-100 dark:from-sky-900/40 dark:via-blue-900/30 dark:to-indigo-900/40 overflow-hidden">
                            ...
                            <button
                                onClick={() => isMobile ? closeMobile() : setIsExpanded(false)}
            ...
            {!isMobile && (
                <div className={`overflow-hidden transition-all duration-500 ease-out ${!expanded ? "max-h-20 opacity-100 p-3" : "max-h-0 opacity-0 p-0"}`}>
            ...
            {/* Navigation Links */}
            <nav className={`mb-5 flex flex-col gap-1 transition-all duration-300 ${expanded ? "px-3" : "px-2"}`}>
                {navItems.map((item, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <span className={`whitespace-nowrap transition-all duration-300 ${expanded ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-2 absolute"}`}>
                                {item.name}
                            </span>
